"""
Animacja podczas generowania pliku audio TTS.
Używa biblioteki rich do wyświetlania animowanego tekstu.
"""
import time
import random
import string
...
# Opóźnienie między klatkami animacji (zwiększone dla mniejszej intensywności)
...
def run_tts_animation(
    ...
    # Zmniejszona częstotliwość odświeżania dla mniejszej intensywności animacji
